#!/bin/bash
set -e
wget -q --show-progress https://github.com/rauldipeas/debian-custom/raw/main/assets/compressed/debian-mac-style.zip
...
cat <<EOF |sudo tee /etc/systemd/system/display-manager.service.d/plymouth.conf
[Unit]
